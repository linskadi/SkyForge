...
const DEFAULT_PROVIDERS: ProviderConfig[] = [
	{
		...
		enabled: true,
		isLocal: false,
		description: "data.provider.deepseek.desc",
	},
	{
		id: "qwen",
		name: "data.provider.qwen.name",
		icon: "🟣",
		...
		enabled: true,
		isLocal: false,
		description: "data.provider.qwen.desc",
	},
	{
		id: "openai",
		name: "OpenAI",
		...
		enabled: false,
		isLocal: false,
		description: "data.provider.openai.desc",
	},
	{
		id: "anthropic",
		name: "Anthropic",
		...
		enabled: false,
		isLocal: false,
		description: "data.provider.anthropic.desc",
	},
	{
		id: "ollama",
		name: "data.provider.ollama.name",
		icon: "🦙",
		...
		enabled: false,
		isLocal: true,
		description: "data.provider.ollama.desc",
	},
	{
		id: "local",
		name: "data.provider.local.name",
		icon: "💻",
		baseURL: "http://localhost:11434/v1",
		apiKey: "local",
		...
		enabled: false,
		isLocal: true,
		description: "data.provider.local.desc",
	},
];
