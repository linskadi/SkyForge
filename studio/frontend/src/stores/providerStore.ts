...
const DEFAULT_PROVIDERS: ProviderConfig[] = [
  {
    ...
    models: [
      ...
      { id: 'deepseek-reasoner', name: 'DeepSeek R1 (Reasoner)', isDefault: false },
    ],
    enabled: true,
    isLocal: false,
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'deepseek-coder-v2:16b', name: 'DeepSeek Coder V2 16B', isDefault: false },
  ...
  },
  {
    ...
    apiKey: 'lm-studio',
    models: [
      { id: 'auto', name: '自动检测 (Loaded Model)', isDefault: true },
    ],
    enabled: false,
    isLocal: true,
...
export const useProviderStore = defineStore('provider', () => {
  ...
  const isLocalModel = computed(() =>
    selectedProvider.value?.isLocal ?? false
  )
