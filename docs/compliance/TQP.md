...
| 工具 | 类型 | TQL 级别 | 鉴定状态 |
|------|------|---------|---------|
| **SkyForge Agent Pipeline** | 开发工具 | TQL-1 | **待鉴定** |
| **LLM 推理引擎** (Qwen3.6-27B) | 开发工具 | TQL-1 | **待鉴定** |
| **Contract Checker** | 验证工具 | TQL-2 | **待鉴定** |
| **Cppcheck** | 验证工具 | TQL-3 | 可引用已有鉴定 |
| **GCC** | 开发工具 | TQL-1 | 可引用已有鉴定 |
| **LM Studio** | 运行环境 | TQL-2 | **待鉴定** |
...
| 活动 | 方法 | 当前覆盖 |
|------|------|---------|
| 单元测试 | Python unittest / Vitest | 204 用例 |
| 集成测试 | 全流程 Pipeline 测试 | 测试报告模块 |
| 异常测试 | 故障注入 + 边界条件 | 数字孪生 5 类故障 |
| 确定性测试 | 同一输入多次运行 | ⚠️ 待实施（LLM 非确定性） |
...
|--------|------|------|
| TQP (本文档) | Markdown | ✅ 草案 |
| TOR (工具操作需求) | Markdown | ⚠️ 待完成 |
| TAS (工具鉴定总结) | Markdown | ❌ 待实施 |
| 工具链验证脚本 | Python | ⚠️ 待实施 |
| 合规矩阵 | Excel | ❌ 待实施 |
...
| 阶段 | 时间 | 目标 |
|------|------|------|
| TQP 草案 | 2026-07-16 | 完成计划文档 |
| TOR 编写 | 2026-07-17 | 完成工具操作需求 |
| 工具链验证 | 2026-07-18 | 完成自动化验证脚本 |
| TAS 编写 | 2026-07-19 | 完成鉴定总结 |
| 合规矩阵 | 2026-07-20 | 完成 Excel 矩阵 |
